...
// Version 1.9
//
// Copyright (c) 2022 by Rhaym Ghellab. all rights reserved.
//
//
// Abdout this SSDT:
//
...
// If so, please open a bug @ https://github.com/rhaym-tech/ThinkSSDT/issues.
...
// Changelog:
//
// version 1.9 - Maybe fix that stupid race condition which leads to 20hrs battery time, fix quickpoll-handling
// version 1.8 - Fix serials for batteries with broken values
// version 1.7 - Fix battery-state handling, small corrections
// version 1.6 - Smaller fixes, adds Notify-patches as EC won't update without them in edge-cases, replaces fake serials with battery-serial
// version 1.5 - fixes, make the whole system more configureable, adds technical backround-documentation
// version 1.4 - optimization, bug-fixing. Adds temp, concatenates string-data on combined batteries. 
// version 1.3 - Waits on initialization of the batts now. Besides that: Optimization, rework, cleanup, fixes. Truely self-contained now. And faster. 
// version 1.2 - Remove need of patched notifies, handle battery attach/detach inside, make the whole device self-contained (exept for the EC-helpers)
// version 1.1 - Prelimitary dual-battery-support, large refactoring
// version 1.0 - Raised timeout for mutexes, factored bank-switching out, added sleep to bank-switching, moved HWAC to its own SSDT
// 
//
